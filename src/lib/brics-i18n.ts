...
const T: Record<string, Record<string, string>> = {
  zh: {
    ...
    'stats.internal':'金砖组织内跨境海缆','stats.domestic':'单一金砖国家海缆',
    ...
    'chart.catInternal':'金砖组织内跨境','chart.catDomestic':'单一国家','chart.catExternal':'对外连接',
    'map.title':'金砖海缆网络',
    'map.internal':'金砖组织内跨境','map.internalTip':'所有登陆站均在金砖国家，且涉及两个及以上不同国家的海缆',
  ...
  en: {
    ...
    'chart.catInternal':'Cross-Border','chart.catDomestic':'Single BRICS Nation','chart.catExternal':'External Connection',
